...
<html lang="en">
  ...
  <head>
    ...
    <?php
        ...
        $query = mysqli_query($con, "Select CONCAT(fname, \" \", lname) AS doctor_name,contact_num,email, CONCAT(address_line1, \" \", address_line2, \" \", address_city, \" \", address_state) AS address,spec_detail FROM doctor");
